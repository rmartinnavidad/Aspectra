        ...
        QTimer::singleShot(0,this,[this,settingsHost,settingCard,settingCardLayout,subNames,index]{
           ...
           if (name == "Layer") {
                ...
                railWidget->setStyleSheet(
                    ...
                    "QListWidget::item { width: 96px; height: 64px; background: #000000; border: 1px solid #2d2d35; border-radius: 8px; margin-right: 8px; color: #ffffff; font-size: 10px; font-weight: 600; padding: 4px; }"
